...
export const metadata: Metadata = {
  title: "Construction Company in Denton | Correa Construction",
  description:
    "Looking for a trusted construction company in Denton? Correa Construction delivers residential and commercial projects with strong planning, safety, and quality control.",
};
    ...
    <div className="bg-white">
      ...
      <main>
        <PageHero
          ...
          description="Correa Construction helps property owners and developers in Denton deliver successful residential and commercial builds from concept through closeout."
        />
        ...
        <ContentSection title="Why Denton Clients Choose Correa Construction">
          <p>
